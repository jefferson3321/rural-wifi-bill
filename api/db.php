...
define('DB_NAME',    'rural_db');
define('DB_USER',    'root');
define('DB_PASS',    '');
define('DB_CHARSET', 'utf8mb4');

// ============================================================
//  APP URL — Pwedeng i-hardcode dito kung gusto
//  Halimbawa: define('APP_URL', 'https://abc123.ngrok-free.app/bill');
// ============================================================
define('APP_URL', '');
...
function getDB(): PDO {
    ...
    throw new PDOException('Cannot connect to database: ' . $lastErr->getMessage());
}
...
function detectPublicHost(): string {
    ...
    if ($fwdHost && $fwdHost !== 'localhost' && strpos($fwdHost, 'ngrok') !== false) {
